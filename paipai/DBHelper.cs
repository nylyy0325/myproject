...
namespace paipai
{
    ...
    {
        static string strConn = System.Configuration.ConfigurationManager.ConnectionStrings["strCon"].ToString();//ConfigurationManager.ConnectionStrings["CnnhoRechargePlatformConnectionString"].ToString();
