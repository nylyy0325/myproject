...
namespace CheckPrice
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //string returnMess = GetUserInfo("nylyy0325", "19850325nyl");

            #region 初始化打码平台

            //string returnMess = RecYZM(@"D:\QQ截图20151021122442.jpg", "nylyy0325", "19850325nyl");

            //Console.WriteLine("{0}", returnMess);
            //Console.ReadLine(); 
            //return;
        ...
        public static void EveryTimeRun(object source, ElapsedEventArgs e)
        {
            ...
            Bitmap bmpend = captureScreen(endprice[0], endprice[1], endprice[2], endprice[3]);//captureScreen(321, 459, 41, 13);
            bmpend.Save(endturl);
